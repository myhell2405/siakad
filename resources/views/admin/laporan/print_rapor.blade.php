...
<body class="bg-gray-100 py-8 px-4 print:bg-white print:py-0 print:px-0">
    ...
    <div class="max-w-4xl mx-auto mb-6 bg-white p-4 rounded-xl shadow flex justify-between items-center no-print border">
    ...
    <!-- ================= HALAMAN 1 ================= -->
    <div class="max-w-4xl mx-auto bg-white p-10 shadow-xl print:shadow-none print:p-0 mb-8 print:mb-0">
    ...
    <!-- ================= HALAMAN 2 ================= -->
    <div class="max-w-4xl mx-auto bg-white p-10 shadow-xl print:shadow-none print:p-0">
