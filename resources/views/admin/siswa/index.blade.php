                    ...
                    <tr class="hover:bg-gray-50/80 transition-colors group">
                        ...
                        <td class="py-4 pr-3 text-right">
                            <div class="inline-flex items-center justify-end gap-1.5">
                                ...
                                <a href="{{ route('admin.siswa.transkrip', $s->id) }}"
                                   title="Lihat Transkrip Nilai"
                                   class="w-8 h-8 rounded-lg bg-gray-100 hover:bg-emerald-600 hover:text-white text-void flex items-center justify-center transition">
